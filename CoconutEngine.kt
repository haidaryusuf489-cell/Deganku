...
class CoconutEngine(private val db:AppDatabase){
    suspend fun open(id:String,water:Int,meat:Int){
        withContext(Dispatchers.IO){
            ...
            db.coconutDao().upsert(c.copy(status=CoconutStatus.TERBUKA,initialWaterMl=water,
                remainingWaterMl=water,initialMeatGram=meat,remainingMeatGram=meat,openedAt=System.currentTimeMillis()))
        }
    }
